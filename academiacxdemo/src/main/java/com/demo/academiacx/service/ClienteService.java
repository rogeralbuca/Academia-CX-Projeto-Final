...
public class ClienteService {
    ...
    public ClienteDto findByUsernameAndPassword(String username, String password){
        ClienteModel clienteModel = clienteRepository.findByUsernameAndPassword(username, password).get();
        return modelMapper.map(clienteModel, ClienteDto.class);
    }
